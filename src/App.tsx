...
const TC_LIST: { id: string; title: string; desc: string; expect: 'pass' | 'fail' | 'maybe'; data: Record<string, any> }[] = [
  ...
  { id: 'TC-05', title: '국민연금 연기 70세', desc: '48세→58세, +36%', expect: 'maybe', data: { currentAge: 48, retirementStartAge: 58, simulationEndAge: 95, monthlyLivingCostBefore75: 3000000, monthlyLivingCostAfter75: 2100000, inflationRate: 2, nationalPensionStartAge: 70, nationalPensionYearly: 15600000, retirementPensions: [], personalPensions: [{ id: 'tc05-irp', type: 'irp', name: 'IRP', balance: 100000000, returnRate: 0.05 }, { id: 'tc05-pi', type: 'pension_savings', name: '연금저축', balance: 50000000, returnRate: 0.04 }], totalPension: 50000000, husbandISA: 100000000, isaReturnRate: 0.05, additionalAssets: [{ id: 'tc05-isa', type: 'isa', name: 'ISA', balance: 100000000, returnRate: 0.05 }], totalDebt: 0, irregularExpenses: [] } },
  { id: 'TC-06', title: '60대 이미 은퇴', desc: '62세 즉시, 자산 4억', expect: 'pass', data: { currentAge: 62, retirementStartAge: 62, simulationEndAge: 90, monthlyLivingCostBefore75: 2500000, monthlyLivingCostAfter75: 1750000, inflationRate: 2, nationalPensionStartAge: 65, nationalPensionYearly: 10800000, retirementPensions: [], personalPensions: [{ id: 'tc06-irp', type: 'irp', name: 'IRP', balance: 200000000, returnRate: 0.03 }, { id: 'tc06-ps', type: 'pension_savings', name: '연금저축', balance: 100000000, returnRate: 0.03 }], totalPension: 100000000, savingsAmount: 100000000, savingsReturnRate: 0.02, additionalAssets: [{ id: 'tc06-savings', type: 'savings', name: '예적금', balance: 100000000, returnRate: 0.02 }], totalDebt: 0, irregularExpenses: [] } },
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: "var(--bg-primary)" }}>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        {/* 데모 배너 — 숨김 처리 */}
        {false && showDemoBanner && currentPage === "retirement-calc" && !isDemoRunning && window.innerWidth > 768 && (
          <div
            id="demo-banner"
